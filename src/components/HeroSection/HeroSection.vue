        ...
        <div class="hero-actions">
          ...
          <div class="social-links">
            ...
            >
              ...
              <svg v-if="social.platform && social.platform.toLowerCase() === 'dribbble'" viewBox="0 0 24 24" class="icon-svg">
              ...
              <svg v-else-if="social.platform && social.platform.toLowerCase() === 'github'" viewBox="0 0 24 24" class="icon-svg">
              ...
              <svg v-else-if="social.platform && social.platform.toLowerCase() === 'instagram'" viewBox="0 0 24 24" class="icon-svg">
              ...
              <svg v-else-if="social.platform && social.platform.toLowerCase() === 'linkedin'" viewBox="0 0 24 24" class="icon-svg">
...
const Balatro = defineAsyncComponent(() => import('./Balatro.vue'));
